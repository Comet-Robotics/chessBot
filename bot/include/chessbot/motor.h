...
namespace chessbot
{
    ...
    public:
        ...
        Motor(gpio_num_t motorChannelA_, gpio_num_t motorChannelB_, int encoderChannelA_, int encoderChannelB_) : encoder(new Encoder(encoderChannelA_, encoderChannelB_)), powerPin(motorChannelA_), channelA(motorChannelA_), channelB(motorChannelB_) {}

        Motor(gpio_num_t motorChannelA_, gpio_num_t motorChannelB_) : powerPin(motorChannelA_), channelA(motorChannelA_), channelB(motorChannelB_) {}
