...
export class Robot {
    ...
    public homeIndices: GridIndices;
    public startHeadingRadians: number;
    public defaultPosition: GridIndices;
    ...
    constructor(
        ...
        this.homeIndices=config[id]["homePosition"]

        this.startHeadingRadians=config[id]["startHeadingRadians"]
        this._headingRadians = this.startHeadingRadians;

        this.defaultPosition=config[id]["defaultPosition"]
        this._position=ZERO_POSITION
